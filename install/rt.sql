...
CREATE TABLE IF NOT EXISTS `select_element` (
  ...
  `default_option` tinyint(1) UNSIGNED NOT NULL DEFAULT '0'
  PRIMARY KEY (`se_id`),
  KEY `element_id` (`element_id`),
  KEY `active` (`active`),
  KEY `default_option` (`default_option`)
...
INSERT INTO `select_element` (`se_id`, `active`, `element_id`, `text`, `default_option`) VALUES
(1, 1, 8, 'AL', 0),
(2, 1, 8, 'AK', 0),
(3, 1, 8, 'AZ', 0),
(4, 1, 8, 'AR', 0),
...
(53, 1, 12, 'Carpentry', 0),
(54, 1, 12, 'Masonry', 0),
(55, 1, 12, 'Electrical', 0),
(56, 1, 12, 'Plumbing', 0),
(57, 1, 12, 'Drywall', 0),
(58, 1, 12, 'Flooring', 0),
(59, 1, 12, 'Cleaning', 0),
(60, 1, 12, 'Landscaping', 0),
(61, 1, 12, 'Painting', 0);
